...
Senior researchers are also welcome to propose **opening talks**. These will be slightly longer than regular oral presentations and consist of short lectures on research lines, breakthrough ideas, or emerging topics.
...
Oral presentations will be **10 minutes long**; all slides must be in English. If your presentation is accepted, please email your slides to [ecoflor2027@gmail.com](mailto:ecoflor2027@gmail.com) by **January 23rd, 2027**.
...
Alternatively, take the **Airport Express bus** to *Praha Hlavní nádraží* (Central Station), then metro line C (red) to *I. P. Pavlova* — a short walk to the faculty.
...
Prague's **public transport** is excellent, affordable (24-hour ticket: ~120 CZK / ~5 EUR), and runs 24 hours. Tickets can be bought from machines at metro stations, in the PID Lítačka mobile app, or by SMS.

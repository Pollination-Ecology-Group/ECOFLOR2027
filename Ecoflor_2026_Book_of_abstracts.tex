...
vs.~intensive). We calculated alpha-, beta-, and gamma-diversity of bees
and built linear models to link bee and flower richness and evaluate
species-area relationships. Bee richness was determined primarily by
beta-diversity, with each pasture hosting many idiosyncratic species,
and increased linearly with flower richness (slope \textasciitilde1).
Bee richness showed opposed species-area relationships depending on
grazing intensity: negative for extensive pastures, and positive for
intensive pastures. As such, there is a threshold at 0.65 ha --below it,
